...
public class RecipientListSerializationTest
{
    ...
    public void CreateRecipientList_request_returns_expected_result()
    {
        var recipientList = new CreateRecipientList
        {
            ...
            {
                new(new Address("wilmaflin@yahoo.com") { Name = "Wilma" })
                {
                ...
                new(new Address("abc@flintstone.com") { Name = "ABC" })
                {
                ...
                new(new Address("fred.jones@flintstone.com") { Name = "Grad Student Office", HeaderTo = "grad-student-office@flintstone.com" })
                {
