...
public static class SendingResponseExtensions
{
    ...
    public static async Task<ResponseListResultWrapper<ListRecipientListsResponseResult>>
        Wrap(Task<Either<ErrorResponse, ListRecipientListsResponse>> response) =>
        (await response.ConfigureAwait(false))
        .Match(
            Success,
    ...
    public static async Task<ResponseWrapper<EmailAddressValidationResponseResult>>
        Wrap(Task<Either<ErrorResponse, EmailAddressValidationResponse>> response) =>
        (await response.ConfigureAwait(false))
        .Match(
            Success,
    ...
    public static async Task<ResponseWrapper<BulkCreateOrUpdateSuppressionsResponseResult>> Wrap(
    ...
    public static async Task<ResponseWrapper<CreateOrUpdateSuppressionResponseResult>> Wrap(
    ...
    public static async Task<ResponseWrapper<RetrieveSuppressionSummaryResponseResult>> Wrap(
    ...
    public static async Task<ResponseListResultWrapper<ListSendingDomainsResponseResult>>
        Wrap(Task<Either<ErrorResponse, ListSendingDomainsResponse>> response) =>
        (await response.ConfigureAwait(false))
        .Match(
            ListSuccess,
    ...
    public static async Task<ResponseListResultWrapper<ListTrackingDomainsResponseResult>> Wrap(
    ...
    public static async Task<ResponseWrapper<RetrieveTrackingDomainResponseResult>>
        Wrap(Task<Either<ErrorResponse, RetrieveTrackingDomainResponse>> response) =>
        (await response.ConfigureAwait(false))
        .Match(
            Success,
