...
namespace SparkPostFun.Sending
{
    public static class ClientRecipientListExtensions
    {
        ...
        public static Task<Either<ErrorResponse, CreateRecipientListResponse>> CreateRecipientList(this Client @this, CreateRecipientList request, int numberOfRecipientErrors)
        {
        ...
        public static Task<Either<ErrorResponse, RetrieveRecipientListResponse>> RetrieveRecipientList(this Client @this, string id, bool showRecipients = false)
        {
        ...
        public static Task<Either<ErrorResponse, UpdateRecipientListResponse>> UpdateRecipientList(this Client @this, string id, UpdateRecipientList request, int numberOfRecipientErrors)
        {
