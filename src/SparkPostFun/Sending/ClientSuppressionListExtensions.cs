...
namespace SparkPostFun.Sending
{
    public static class ClientSuppressionListExtensions
    {
        public static Task<Either<ErrorResponse, BulkCreateOrUpdateSuppressionsResponse>> BulkCreateOrUpdateSuppressions(this Client @this,
            IList<BulkCreateOrUpdateSuppressions> request)
        {
        ...
        public static Task<Either<ErrorResponse, RetrieveSuppressionResponse>> RetrieveSuppression(this Client @this, string recipient,
            IList<SuppressionType> types, string cursor, int page, int? perPage)
        {
            var requestUrl = $"/api/{@this.Version}/suppression-list/{recipient}";
        ...
        public static Task<Either<ErrorResponse, SearchSuppressionsResponse>> SearchSuppressions(this Client @this, DateTime to, DateTime from, string domain,
            IList<SuppressionSource> sources, IList<SuppressionType> types, string description, bool descriptionStrict, string cursor, int page, int? perPage,
            SortOrder sort)
        {
