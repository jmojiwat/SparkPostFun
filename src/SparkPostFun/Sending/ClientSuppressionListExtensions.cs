...
public static class ClientSuppressionListExtensions
{
    ...
    public static Task<Either<ErrorResponse, RetrieveSuppressionResponse>> RetrieveSuppression(this Client @this, string recipient, RetrieveSuppressionFilter filter)
    {
        var queryString = ToQueryString(filter);
    ...
    public static Task<Either<ErrorResponse, RetrieveSuppressionResponse>> RetrieveSuppression(this Client @this, string recipient, RetrieveSuppressionFilter filter, int subaccountId)
    {
        var queryString = ToQueryString(filter);
        var requestUrl = $"/api/{@this.Version}/suppression-list/{recipient}?{queryString}";
        return @this.GetWithSubaccount<RetrieveSuppressionResponse>(requestUrl, subaccountId);
